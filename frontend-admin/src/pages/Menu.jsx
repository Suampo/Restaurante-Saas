...
import VirtualizedMenuGrid from "../components/VirtualizedMenuGrid";
    ...
    <div className="py-6">
      <div className="mx-auto w-full max-w-7xl px-4">
        ...
        {loading ? (
          ...
          <VirtualizedMenuGrid
            items={pageItems}
            // ancho mínimo de cada card (px)
            minColumnWidth={260}
            // alto aproximado de cada fila (px)
            rowHeight={360}
            renderItem={(it) => {
              const catId = it.categoria_id ?? it.categoriaId;
              return (
