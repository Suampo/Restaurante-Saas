...
const IconBag = (p) => (
  <svg viewBox="0 0 24 24" width="18" height="18" {...p}>
    <path fill="currentColor" d="M6 7V6a6 6 0 1 1 12 0v1h1a2 2 0 0 1 2 2l-1 11a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3L3 9a2 2 0 0 1 2-2h1zm2 0h8V6a4 4 0 0 0-8 0v1z"/>
  </svg>
);
const IconExternal = (p) => (
  <svg viewBox="0 0 24 24" width="16" height="16" {...p}>
    <path fill="currentColor" d="M14 3h7v7h-2V6.41l-9.29 9.3-1.42-1.42 9.3-9.29H14V3z"/><path fill="currentColor" d="M5 5h6v2H7v10h10v-4h2v6H5z"/>
  </svg>
);
const IconCopy = (p) => (
  <svg viewBox="0 0 24 24" width="16" height="16" {...p}>
    <path fill="currentColor" d="M16 1H4a2 2 0 0 0-2 2v12h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 14H8V7h11v12z"/>
  </svg>
);
const IconDownload = (p) => (
  <svg viewBox="0 0 24 24" width="16" height="16" {...p}>
    <path fill="currentColor" d="M5 20h14v-2H5m7-14v8l3.5-3.5 1.42 1.42L12 18l-4.92-4.92L8.5 11.7 12 15V6h2z"/>
  </svg>
);
const IconRefresh = (p) => (
  <svg viewBox="0 0 24 24" width="16" height="16" {...p}>
...
const IconPrint = (p) => (
  <svg viewBox="0 0 24 24" width="16" height="16" {...p}>
    <path fill="currentColor" d="M19 8H5a3 3 0 0 0-3 3v4h4v4h12v-4h4v-4a3 3 0 0 0-3-3zm-3 11H8v-5h8v5zM18 3H6v4h12V3z"/>
  </svg>
);
    ...
    <div className="rounded-2xl border bg-white shadow-sm ring-1 ring-black/5">
      ...
      <div className="flex items-start justify-between gap-3 border-b px-4 py-3">
        ...
        <div className="inline-flex items-center gap-2">
          <span className="rounded-full bg-amber-100 px-2 py-0.5 text-xs font-medium text-amber-800">Para llevar</span>
          <button
            type="button"
            onClick={load}
      ...
      {/* Body */}
      <div className="grid items-start gap-4 p-4 md:grid-cols-[260px_1fr]">
        {/* QR + acciones */}
        <div className="flex flex-col items-center">
          <div className="rounded-xl border bg-white p-2 shadow-sm">
            {loading ? (
              ...
              <div className="h-[220px] w-[220px] grid place-items-center text-sm text-rose-700">
                {error}
              </div>
            ) : (
              <img
        ...
        <div className="space-y-2">
          ...
          <details className="rounded-xl border bg-neutral-50/60 p-3 text-sm text-neutral-700">
            <summary className="cursor-pointer select-none text-[13px] text-neutral-600">
              {showFull ? "Ocultar link" : "Ver link completo"}
            </summary>
            <div className="mt-2 break-words text-[13px]" onClick={() => setShowFull(!showFull)}>
              {link}
            </div>
          </details>
        </div>
